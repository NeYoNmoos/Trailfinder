...
public class DeleteRouteTest {
  ...
  public void deleteRoute() {
    driver.get("http://localhost:8080/hike_war_exploded/");
    driver.manage().window().setSize(new Dimension(2016, 1296));
    driver.findElement(By.cssSelector(".block:nth-child(1) > .text-gray-600")).click();
    driver.findElement(By.cssSelector(".h-5")).click();
    assertThat(driver.switchTo().alert().getText(), is("Are you sure you want to delete this route?"));
