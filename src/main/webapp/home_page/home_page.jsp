        ...
        <div class="w-full h-auto max-w-[100vw] max-h-[80vh]">
            <div class="swiper h-[80vh] w-full">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <img src="${pageContext.request.contextPath}/assets/home_page_img/foggy-trail.jpeg" class="mb-4 w-full h-full object-cover object-center">
                    </div>
                    <div class="swiper-slide">
                        <img src="${pageContext.request.contextPath}/assets/home_page_img/biking-trail.jpeg" class="mb-4 w-full h-full object-cover object-center">
                    </div>
                </div>
                <div class="swiper-pagination"></div>
                <div class="swiper-scrollbar"></div>
            </div>
            <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 flex justify-center">
                <input type="text" name="routename" id="routename" class="mt-1 w-96 h-10 text-lg p-2 border-gray-300 rounded-md shadow-sm content-center my-10" placeholder="Search by Name, Place, Hut" value="<%= request.getParameter("routename") == null?"":request.getParameter("routename") %>">
                        ...
                        <a href="<%= detailPageUrl %>" class="block text-black bg-white rounded-lg shadow p-4 hover:shadow-md hover:scale-[1.05] transition duration-300 overflow-hidden">
                            <%
                                ...
                                if (gallery != null && !gallery.isEmpty()) {
                                    ...
                                    <img src="${pageContext.request.contextPath}/assets/home_page_img/header-image.jpg" alt="<%= currentRoute.getName() %> Image" class="mb-4 w-full h-40 object-cover object-center rounded-md grayscale"><%
                                }
                            %>
